...
public class AvatarGenerator : MonoBehaviour
{
    ...
    public List<Tuple<string, int, int>> SettingsList;
    ...
    List<Tuple<string, int, int>> settingsToList()
    {
        List<Tuple<string, int, int>> listSettings = new List<Tuple<string, int, int>>();

        listSettings.Add(new Tuple<string, int, int>("Extraversion", minExtraversion, maxExtraversion));
        listSettings.Add(new Tuple<string, int, int>("Egoism", minEgoism, maxEgoism));
        listSettings.Add(new Tuple<string, int, int>("Thoroughness", minThorougness, maxThorougness));
        listSettings.Add(new Tuple<string, int, int>("EmotionalStability", minEmotionalStability, maxEmotionalStability));
